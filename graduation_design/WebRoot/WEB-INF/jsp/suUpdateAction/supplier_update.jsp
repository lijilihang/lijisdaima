		...
		<div class="sysmain clearfix">
			...
			<div class="sysinfo">
				<p class="sinfotit">供应商查询</p>
				 <h1>供应商信息更新</h1>
    <form action="${pageContext.request.contextPath }/updateSupplier?suId=${suId }" method="post">
        <c:forEach items="${supplierlist}" var="u">
    	
    	供应商名：<input type="text" name="suName" value="${u.suName }"/><br/>
    	供应商地址：<input type="text" name="suAddress" value="${u.suAddress }"/><br/>
    	供应商电话：<input type="text" name="suTel" value="${u.suTel }"/><br/>
    	供应商邮箱：<input type="text" name="suMail" value="${u.suMail }"/><br/>
    	</c:forEach>
    	<hr>
