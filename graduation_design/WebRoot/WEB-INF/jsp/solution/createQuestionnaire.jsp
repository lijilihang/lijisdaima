...
<link rel="stylesheet" type="text/css" href="css/question/wenjuan_ht.css">
...
<div class=" all_660">
    ...
    <div class="but" style="padding-top: 40px">
        ...
        <button id="addQ" class="mybutton">添加问题</button> <button id='submitQ' class="mybutton">提交问题</button>
        <button id='goBack' class="mybutton"><a href="${pageContext.request.contextPath }/goExamList" class="gobackHref">返回</a></button>
    </div>
    <!--选项卡区域  模板区域---------------------------------------------------------------------------------------------------------------------------------------->
    <div class="xxk_box">
        <div class="xxk_conn hide">
            ...
            <div class="xxk_xzqh_box dxuan ">
                ...
                <div class="title_itram">
                    <div class="kzjxx_iteam">
                        ...
                        <input name="" type="text"  value="" class="fxkk"> <span>分数</span>
            ...
            <div class="xxk_xzqh_box duoxuan hide">
                <textarea name="" cols="" rows="" class="input_wenbk btwen_text btwen_text_duox" placeholder="请输入多选题目？"></textarea>
                <div class="title_itram">
                    <div class="kzjxx_iteam">
            ...
            <div class="xxk_xzqh_box tktm hide">
                <textarea name="" cols="" rows="" class="input_wenbk btwen_text btwen_text_tk" placeholder="题目请在这里编写"></textarea>
                <!--完成编辑-->
                <div class="bjqxwc_box">
                    <a href="javascript:void(0);" class="qxbj_but">取消编辑</a>
                    <a href="javascript:void(0);" class="swcbj_but"> 完成编辑</a>
...
<script type="text/javascript">
  window.addQuestionListPath = "${pageContext.request.contextPath }/addQuestionList";
  window.linkPath = "${pageContext.request.contextPath }/goShowLink";
</script>
