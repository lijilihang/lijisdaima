...
<div class="box_m">
  ...
  <div class="mainText" id="examListPage">
     
     <div class="examBoardTitle">我的问卷</div>
     <div class="flex-container">
      <div class="flex-item" v-for="item in items">
        <p class="wenjuan">{{item.examTitle}}</p>
        <p class="createTime">创建时间：{{item.examCreateTime}}</p>
        <p class="createTime">开始时间：{{item.examBeginTime}}</p>
        <p class="createTime">结束时间：{{item.examEndTime}}</p>
        <img alt="" class="editImage" @click="goEdit(item.examId)" src="css/question/images/edit.png">
        <img alt="" class="deleteImage" @click="deleteExam(item.examId)" src="css/question/images/delete.png">
      </div>
     </div>
  </div>
...
<script type="text/javascript">
  ...
  window.getExamListPath = "${pageContext.request.contextPath }/getExamList";
  window.getCreateQuestionPath = "${pageContext.request.contextPath }/goCreateQuestionnaire";
  window.deleteExamPath = "${pageContext.request.contextPath }/deleteExam";
  window.goSelfPath = "${pageContext.request.contextPath }/goExamList";
  window.getQuestionPath = "${pageContext.request.contextPath }/getQuestion";
  window.goShowLinkPath = "${pageContext.request.contextPath }/goShowLink";
</script>
<script type="text/javascript" src="js/question/examListVue.js"></script>
</body>
</html>